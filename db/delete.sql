...
drop index if exists regionnameindex;
drop index if exists itemNameIndex;
drop index if exists currencyNameIndex;
drop index if exists itemTypeNameIndex;
drop index if exists clanName;
drop index if exists rewardName;
